...
func (g *GroupCoordinatorStandalone) addNewMemberAndReBalance(group *Group, clientId, memberId, protocolType string, protocols []*service.GroupProtocol) (string, error) {
	group.groupMemberLock.RLock()
